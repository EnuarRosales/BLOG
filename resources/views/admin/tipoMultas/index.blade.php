...
@section('content_header')
    <h2 class="ml-3">Lista tipo multas</h2>
@stop
...
@section('content')
    ...
    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
        <div class="widget-content widget-content-area br-6">
            <div class="row g-2">
                <div class="col">
                    <a class="btn btn-primary float-right mr-4" href="{{ route('admin.tipoMultas.create') }}">Agregar tipo
                        multa</a>
                            ...
                            <tr>
                                ...
                                <td width="10px">
                                    <a href="javascript:void(0);" class="ml-2 eliminar-registro rounded bs-tooltip"
                                        data-placement="top" title="Eliminar" data-tipoMulta-id="{{ $tipoMulta->id }}">
        ...
        function bindDeleteEvents() {
            document.querySelectorAll('.eliminar-registro').forEach(botonEliminar => {
                botonEliminar.addEventListener('click', function(e) {
                    ...
                    const tipoMultasId = this.getAttribute('data-tipoMulta-id');
                    ...
                    Swal.fire({
                        ...
                        preConfirm: () => {
                            ...
                            formulario.action =
                            `tipoMultas/${tipoMultasId}`; // Ruta de eliminación
