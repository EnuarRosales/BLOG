    ...
    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
        <div class="widget-content widget-content-area br-6">
            <div class="row g-2">
                ...
                <div class="col">
                    <a class="btn btn-primary float-right" href="{{ route('admin.tipoDescuentos.create') }}">Agregar tipo
                        descuento</a>
                </div>
            </div>
                    ...
                    <tbody>
                        @foreach ($tipoDescuentos as $tipoDescuento)
                            <tr>
                                ...
                                <td width="10px">
                                    <a href="{{ route('admin.tipoDescuentos.edit', $tipoDescuento) }}" class=" bs-tooltip"
                                ...
                                <td width="10px">
                                    <a href="javascript:void(0);" class="ml-2 eliminar-registro rounded bs-tooltip"
                                        data-placement="top" title="Eliminar" data-tipoDescuento-id="{{ $tipoDescuento->id }}">
    ...
    <script>
        document.querySelectorAll('.eliminar-registro').forEach(botonEliminar => {
            botonEliminar.addEventListener('click', function(e) {
                ...
                const tipoDescuentosId = this.getAttribute('data-tipoDescuento-id');
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        formulario.action = `tipoDescuentos/${tipoDescuentosId}`; // Ruta de eliminación
