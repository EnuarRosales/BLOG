        ...
        <div class="widget-content widget-content-area br-6">
            <div class="row g-2">
                ...
                <div class="col">
                    ...
                    <a class="btn btn-primary float-right" href="{{ route('admin.impuestos.create') }}">Agregar Impuesto</a>
            ...
            botonEliminar.addEventListener('click', function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        formulario.action = `impuestos/${registroId}`; // Ruta de eliminación
