    ...
    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
        <div class="widget-content widget-content-area br-6">
            <div class="row g-2">
                ...
                <div class="col">
                    <a class="btn btn-primary float-right" href="{{ route('admin.tipoUsuarios.create') }}">Agregar
                        TipoUsuario</a>

                    {{-- <a class="btn btn-success " href="">Agregar Empresa</a> --}}
                    ...
                    <tbody>
                        @foreach ($tipoUsuarios as $tipoUsuario)
                            <tr>
                                ...
                                <td width="10px">
                                    <a href="{{ route('admin.tipoUsuarios.edit', $tipoUsuario) }}" class=" bs-tooltip"
                                ...
                                <td width="10px">
                                    <a href="javascript:void(0);" class="ml-2 eliminar-registro rounded bs-tooltip"
                                        data-placement="top" title="Eliminar" data-tipoUsuario-id="{{ $tipoUsuario->id }}">
    ...
    <script>
        document.querySelectorAll('.eliminar-registro').forEach(botonEliminar => {
            botonEliminar.addEventListener('click', function(e) {
                ...
                const tipoUsuariosId = this.getAttribute('data-tipoUsuario-id');
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        formulario.action = `tipoUsuarios/${tipoUsuariosId}`; // Ruta de eliminación
