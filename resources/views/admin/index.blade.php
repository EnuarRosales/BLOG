...
@section('content')
    ...
    <div class="container text-center">
        <div class="row">
            <div class="col">
                <x-adminlte-small-box title={{$user}}  text="{{$porcentajeUser}}%   Modelos" icon="fa fa-user-plus fa-lg"
            ...
            <div class="col">
                <x-adminlte-small-box title="{{$asignacionMultas.' '.$porcentajeUser}} %" text="otro valor" icon="fas fa-user-plus text-teal"
