...
@section('tittle-tab')
    Personal-Asignacion Rooms
@endsection

@section('page-title')
    <a href="{{ route('admin.asignacionRooms.index') }}">Personal-Asignacion Rooms</a>
@endsection

@section('content_header')
    <h2 class="ml-3">Listado asignacion rooms</h2>
@stop
            ...
            <div class="row g-2">
                <div class="col">
                    @can('admin.asignacionRooms.create')
                        <a class="btn btn-primary float-right mr-4" href="{{ route('admin.asignacionRooms.create') }}">Agregar
                            Asignacion
                            Room</a>
                    @endcan
                </div>
                    ...
                    <tbody>
                        @foreach ($asignacionRooms as $asignacionRoom)
                            <tr>
                                ...
                                @can('admin.asignacionRooms.edit')
                                    <td width="10px">
                                        <a href="{{ route('admin.asignacionRooms.edit', $asignacionRoom) }}"
                                ...
                                <td width="10px">
                                    <a href="javascript:void(0);" class="ml-2 eliminar-registro rounded bs-tooltip"
                                        ...
                                        data-asignacionRoom-id="{{ $asignacionRoom->id }}">
        ...
        function bindDeleteEvents() {
            document.querySelectorAll('.eliminar-registro').forEach(botonEliminar => {
                botonEliminar.addEventListener('click', function(e) {
                    ...
                    const asignacionRoomId = this.getAttribute('data-asignacionRoom-id');
                    ...
                    Swal.fire({
                        ...
                        preConfirm: () => {
                            ...
                            formulario.action =
                                `asignacionRooms/${asignacionRoomId}`; // Ruta de eliminación
