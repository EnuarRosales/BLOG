...
<body class="error404 text-center">
    ...
    <div class="container-fluid error-content">
        <div class="">
            <h1 class="error-number">404</h1>
            <p class="mini-text">¡Ups!</p>
            <p class="error-text mb-4 mt-1">La página que ha solicitado no se encontró.</p>
            <button class="btn btn-primary mt-5 home-button form-control" onclick="location.href='{{ route('home') }}'">
