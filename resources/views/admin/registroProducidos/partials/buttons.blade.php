@can('admin.registroProduccion.edit')
    <td width="10px">
                        <a href="{{ route('admin.registroProducidos.edit', $registroProducido) }}" class="ml-4 rounded bs-tooltip"
...
@can('admin.registroProduccion.destroy')
    <td width="10px">
        <a href="javascript:void(0);" class="ml-2 eliminar-registro rounded bs-tooltip" data-placement="top"
                title="Eliminar" data-registroProducido-id="{{ $registroProducido->id }}">
