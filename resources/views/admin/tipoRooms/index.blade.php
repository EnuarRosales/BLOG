...
@section('content')
    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
        <div class="widget-content widget-content-area br-6">
            <div class="row g-2">
                <div class="col">
                    <a class="btn btn-primary float-right mr-4" href="{{ route('admin.tipoRooms.create') }}">Agregar tipo
                        room</a>
                </div>
            </div>
                    ...
                    <tbody>
                        @foreach ($tipoRooms as $tipoRoom)
                            <tr>
                                ...
                                <td width="10px">
                                    <a href="{{ route('admin.tipoRooms.edit', $tipoRoom) }}" class=" bs-tooltip"
                                ...
                                <td width="10px">
                                    <a href="javascript:void(0);" class="ml-2 eliminar-registro rounded bs-tooltip"
                                        data-placement="top" title="Eliminar" data-tipoRoom-id="{{ $tipoRoom->id }}">
        ...
        function bindDeleteEvents() {
            document.querySelectorAll('.eliminar-registro').forEach(botonEliminar => {
                botonEliminar.addEventListener('click', function(e) {
                    ...
                    const tipoRoomsId = this.getAttribute('data-tipoRoom-id');
                    ...
                    Swal.fire({
                        ...
                        preConfirm: () => {
                            ...
                            formulario.action =
                            `tipoRooms/${tipoRoomsId}`; // Ruta de eliminación
